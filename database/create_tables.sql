...
CREATE TABLE matches (
    ...
    winner_advances_to_tournament_id INT NULL,
    winner_advances_to_match_id INT NULL,
    loser_advances_to_tournament_id INT NULL,
    loser_advances_to_match_id INT NULL,
    parent_winner_match_id INT NULL,
    parent_loser_match_id INT NULL,
    PRIMARY KEY (tournament_id, match_id),
    FOREIGN KEY (tournament_id) REFERENCES tournaments(tournament_id),
    FOREIGN KEY (team1_id) REFERENCES teams(team_id),
    FOREIGN KEY (team2_id) REFERENCES teams(team_id),
    FOREIGN KEY (winner_advances_to_tournament_id, winner_advances_to_match_id) REFERENCES matches(tournament_id, match_id),
    FOREIGN KEY (loser_advances_to_tournament_id, loser_advances_to_match_id) REFERENCES matches(tournament_id, match_id),
